    ...
    public static void upAnh(Player currentPlayer) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            for (File selectedFile : selectedFiles) {
                ...
                String storagePath = "Image/Player_avatar/" + fileName;
                File storageDir = new File("Image/Player_avatar");
                ...
                try {
                    ...
                    System.out.println("File " + fileName + " has copied to " + storagePath);

                    // Đổi tên file đã copy trong folder mới theo tên của Player
                    File newFile = new File(storagePath);
                    File renamedFile = new File("Image/Player_avatar/" + playerFileName);
